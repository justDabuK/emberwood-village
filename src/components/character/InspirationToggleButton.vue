...
<template>
  <input type="checkbox" v-model="inspiration" class="secondary" id="inspiration"/>
  <label for="inspiration">
    <svg v-if="inspiration" class="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
